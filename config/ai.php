...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Storage for agents using the RemembersConversations trait. Title
    | generation is off by default: it would spend an extra model call on
    | every new conversation and issue an HTTP request the test suite forbids.
    |
    */

    'conversations' => [
        'connection' => env('AI_CONVERSATIONS_CONNECTION'),
        'generate_title' => env('AI_GENERATE_CONVERSATION_TITLES', false),
        'tables' => [
